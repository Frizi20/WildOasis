...
function Pagination({ count }) {
    ...
    const currPage = !pageQuery ? 1 : pageQuery;

    // !pageQuery ? (currPage = 1) : (currPage = pageQuery);
    ...
    return (
        <StyledPagination>
            <P>
                ...
                <span>  {pageCount === currPage ? count : PAGE_SIZE * currPage} </span> of
                <span>  {count} </span> results
            </P>

            <Buttons>
                <PaginationButton disabled={currPage === 1} onClick={prevPage}>
